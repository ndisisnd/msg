---
name: bucket-a11y
description: Pre-merge accessibility bucket — WCAG audit across pages/components via the detected runner. Parse violations to canonical findings.
---
...
Bucket fields: `runner`, `command`, `targets_audited`, `errors[]`, `totals` (critical/serious/moderate/minor).
