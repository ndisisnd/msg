...
TARGETS=(devkit/AHA.md devkit/DOCTOR.md devkit/GLOSSARY.md devkit/ARCHITECTURE.md devkit/DESIGN-SYSTEM.md devkit/OPEN-QUESTIONS.md devkit/PLATFORMS.md devkit/policy.json .claude/msg/pref.json README.md .gitignore CLAUDE.md CHANGELOG.md INTAKE.md features/planned/ features/wip/ features/done/)
