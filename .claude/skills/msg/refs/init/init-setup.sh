...
TARGETS=(devkit/AHA.md devkit/GLOSSARY.md devkit/ARCHITECTURE.md devkit/DESIGN-SYSTEM.md devkit/OPEN-QUESTIONS.md devkit/PLATFORMS.md devkit/policy.json README.md .gitignore CLAUDE.md CHANGELOG.md INTAKE.md features/)
