...
| 19 | [plan-loop-modes](19-plan-loop-modes/plan.md) | Add --loop orchestration to plan-pm and eng --build, and post-completion AskUserQuestion prompts to plan-pm and plan-em in non-loop mode. | In-progress |
