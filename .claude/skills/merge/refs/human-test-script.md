...
generate-once checklist pre-merge emits; merge renders
...
- End with the sign-off prompt framing: "When you've checked these on staging, come back and tell merge whether it works."
