...
Usage:
  plan-em-exec-collision.sh [--waves] <exec-table.md>
  cat exec-table.md | plan-em-exec-collision.sh [--waves]
  plan-em-exec-collision.sh <exec-table.md> --waves   # flag before or after the path
